...
nv.models.dialChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            // Setup containers and skeleton of chart
            var wrap = container.selectAll('g.nv-wrap.nv-dailChart').data([data]);
            var gEnter = wrap.enter().append('g').attr('class', 'nvd3 nv-wrap nv-dailChart').append('g');
            var g = wrap.select('g');
        ...
        renderWatch.renderEnd('diChart immediate');
        return chart;
    }
